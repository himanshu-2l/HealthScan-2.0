...
export const SiteFooter: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-100 dark:bg-[#0a0a0f] text-slate-800 dark:text-white border-t border-slate-200 dark:border-white/[0.06] transition-colors duration-200">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Brand Section */}
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <Brain className="w-8 h-8 text-teal-600 dark:text-blue-400" />
              <Stethoscope className="w-8 h-8 text-emerald-600 dark:text-green-400" />
            </div>
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">Health Scan</h3>
            ...
            <div className="flex gap-2">
              <Badge className="bg-teal-600 dark:bg-blue-600 text-white text-xs">ABDM Integrated</Badge>
              <Badge className="bg-emerald-600 dark:bg-green-600 text-white text-xs">Government Approved</Badge>
            </div>
          </div>

          {/* Platform Links */}
          <div>
            <h4 className="font-semibold text-lg mb-4 text-slate-900 dark:text-white">Platform</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="font-semibold text-lg mb-4 text-slate-900 dark:text-white">Resources</h4>
            <ul className="space-y-2">
          ...
          {/* Government Links */}
          <div>
            <h4 className="font-semibold text-lg mb-4 flex items-center gap-2 text-slate-900 dark:text-white">
              <Shield className="w-5 h-5 text-teal-600 dark:text-blue-400" />
              Government
            </h4>
            <ul className="space-y-2">
        ...
        {/* Bottom Section */}
        <div className="border-t border-slate-200 dark:border-white/[0.06] pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-slate-600 dark:text-white/60 text-sm text-center md:text-left">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 text-slate-600 dark:text-white/60 text-sm">
                <Heart className="w-4 h-4 text-rose-500 dark:text-red-400" />
          ...
          <div className="mt-6 pt-6 border-t border-slate-200 dark:border-white/[0.06]">
            <div className="flex flex-wrap justify-center gap-6 text-xs text-slate-500 dark:text-white/40">
              <div className="flex items-center gap-2">
                <Activity className="w-4 h-4 text-teal-600 dark:text-blue-400" />
