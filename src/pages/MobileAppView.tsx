          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div 
                ...
                className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0F1523] border border-slate-200/90 dark:border-white/[0.08] hover:border-sky-500/40 dark:hover:border-sky-500/30 group transition cursor-pointer active:scale-[0.99] space-y-4 shadow-sm"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3.5 min-w-0">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl overflow-hidden relative shrink-0 border border-sky-200/80 dark:border-sky-500/30 bg-sky-50 dark:bg-sky-950/40 shadow-sm">
                      <img
                        src="/images/diabetes-cgm-scan.jpg"
                        alt="Diabetes & CGM Hub"
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                        loading="lazy"
                      />
                      <div className="absolute bottom-1 right-1 p-1 rounded-md bg-slate-950/85 backdrop-blur-md text-sky-400 border border-white/10 shadow-sm">
                        <Droplet className="w-3 h-3" />
                      </div>
                    </div>
                    <div className="min-w-0">
                      <h3 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-sky-600 dark:group-hover:text-sky-300 transition-colors">Diabetes & Insulin Hub</h3>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-1">IOB bilinear decay & carb calculator</p>
                    </div>
                  </div>
                  <span className="px-2 py-0.5 rounded text-[10px] font-semibold bg-sky-500/10 text-sky-700 dark:text-sky-300 border border-sky-500/20 shrink-0">
                    CGM Synced
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between text-xs text-slate-700 dark:text-slate-300 font-semibold group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors">
              ...
              <div 
                ...
                className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0F1523] border border-slate-200/90 dark:border-white/[0.08] hover:border-rose-500/40 dark:hover:border-rose-500/30 group transition cursor-pointer active:scale-[0.99] space-y-4 shadow-sm"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3.5 min-w-0">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl overflow-hidden relative shrink-0 border border-rose-200/80 dark:border-rose-500/30 bg-rose-50 dark:bg-rose-950/40 shadow-sm">
                      <img
                        src="/images/bp-hypertension-scan.jpg"
                        alt="Hypertension & BP Log"
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                        loading="lazy"
                      />
                      <div className="absolute bottom-1 right-1 p-1 rounded-md bg-slate-950/85 backdrop-blur-md text-rose-400 border border-white/10 shadow-sm">
                        <Heart className="w-3 h-3" />
                      </div>
                    </div>
                    <div className="min-w-0">
                      <h3 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-rose-600 dark:group-hover:text-rose-300 transition-colors">Hypertension & BP Log</h3>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-1">AHA stage classification & trend tracker</p>
                    </div>
                  </div>
                  <span className="px-2 py-0.5 rounded text-[10px] font-semibold bg-rose-500/10 text-rose-700 dark:text-rose-300 border border-rose-500/20 shrink-0">
                    AHA Guidelines
                  </span>
                </div>
                <div className="grid grid-cols-2 gap-3 p-3 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200/80 dark:border-white/[0.04]">
                ...
                <div className="flex items-center justify-between text-xs text-slate-700 dark:text-slate-300 font-semibold group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors">
              ...
              <div 
                ...
                className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0F1523] border border-slate-200/90 dark:border-white/[0.08] hover:border-teal-500/40 dark:hover:border-teal-500/30 group transition cursor-pointer active:scale-[0.99] flex items-center justify-between shadow-sm"
              >
                <div className="flex items-center gap-4 min-w-0">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden relative shrink-0 border border-slate-200/80 dark:border-white/[0.08] bg-slate-100 dark:bg-white/[0.03] shadow-sm">
                    <img
                      src="/images/smartwatch-telemetry-scan.jpg"
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-1 sm:line-clamp-none">Apple Watch, Google Fit, Galaxy Watch Bluetooth telemetry</p>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-slate-400 group-hover:text-teal-600 dark:group-hover:text-teal-400 group-hover:translate-x-0.5 transition-all shrink-0 ml-2" />
              </div>
              ...
              <div 
                ...
                className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0F1523] border border-slate-200/90 dark:border-white/[0.08] hover:border-rose-500/40 dark:hover:border-rose-500/30 group transition cursor-pointer active:scale-[0.99] flex items-center justify-between shadow-sm"
              >
                <div className="flex items-center gap-4 min-w-0">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden relative shrink-0 border border-rose-200/80 dark:border-rose-500/30 bg-rose-50 dark:bg-rose-950/30 shadow-sm">
                    <img
                      src="/images/emergency-sos-scan.jpg"
                      alt="Emergency SOS"
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                      loading="lazy"
                    />
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-1 sm:line-clamp-none">One-tap medical dispatch & automated caregiver notifications</p>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-slate-400 group-hover:text-rose-600 dark:group-hover:text-rose-400 group-hover:translate-x-0.5 transition-all shrink-0 ml-2" />
              </div>

              {/* Hormonal Health & Cycle Intelligence */}
              <div 
                onClick={() => navigate('/period-tracker')}
                className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0F1523] border border-slate-200/90 dark:border-white/[0.08] hover:border-pink-500/40 dark:hover:border-pink-500/30 group transition cursor-pointer active:scale-[0.99] flex items-center justify-between shadow-sm"
              >
                <div className="flex items-center gap-4 min-w-0">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden relative shrink-0 border border-pink-200/80 dark:border-pink-500/30 bg-pink-50 dark:bg-pink-950/30 shadow-sm">
                    <img
                      src="/images/hormonal-health-scan.jpg"
                      alt="Hormonal Health & Cycle Intelligence"
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                      loading="lazy"
                    />
                    <div className="absolute bottom-1 right-1 p-1 rounded-md bg-slate-950/85 backdrop-blur-md text-pink-400 border border-white/10 shadow-sm">
                      <Activity className="w-3.5 h-3.5" />
                    </div>
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-colors">Hormonal Health & Cycle Intelligence</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-1 sm:line-clamp-none">28-day ovarian cycle, follicular/luteal phases & PCOS risk score</p>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-slate-400 group-hover:text-pink-600 dark:group-hover:text-pink-400 group-hover:translate-x-0.5 transition-all shrink-0 ml-2" />
              </div>

              {/* AI Clinical Symptom Triage */}
              <div 
                onClick={() => navigate('/symptom-checker')}
                className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0F1523] border border-slate-200/90 dark:border-white/[0.08] hover:border-emerald-500/40 dark:hover:border-emerald-500/30 group transition cursor-pointer active:scale-[0.99] flex items-center justify-between shadow-sm"
              >
                <div className="flex items-center gap-4 min-w-0">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden relative shrink-0 border border-emerald-200/80 dark:border-emerald-500/30 bg-emerald-50 dark:bg-emerald-950/30 shadow-sm">
                    <img
                      src="/images/symptom-checker-scan.jpg"
                      alt="AI Clinical Symptom Triage"
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                      loading="lazy"
                    />
                    <div className="absolute bottom-1 right-1 p-1 rounded-md bg-slate-950/85 backdrop-blur-md text-emerald-400 border border-white/10 shadow-sm">
                      <Stethoscope className="w-3.5 h-3.5" />
                    </div>
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">AI Clinical Symptom Triage</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-1 sm:line-clamp-none">Interactive 3D body map & differential red-flag urgency</p>
                  </div>
                </div>
